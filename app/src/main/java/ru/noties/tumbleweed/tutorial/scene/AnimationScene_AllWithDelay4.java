...
public class AnimationScene_AllWithDelay4 extends AnimationScene {

    public AnimationScene_AllWithDelay4() {
        super("All with delay (repeat yoyo)");
    }
    ...
    public String description() {
        return "Fade in views sequentially applying increasing delay " +
                "for each and showing how to repeat timeline with reverse";
    }
}
